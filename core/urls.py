...
urlpatterns = [
                  ...
                  path('assignment-create/<courz>', AssignmentCreateView.as_view(), name='assignment-create'),
                  path('assignment/<lab>/', AssignmentView.as_view(), name='assignment-list'),
                  path('<pk>/delete/<courz>', AssignmentDeleteView.as_view(), name='delete-assignment'),
                  ...
                  path('assignment-submission/<assigns>/', AssignmentSubmissionView.as_view(), name='assignment-submission'),
                  ...
                  path('assignment-submission-list/<assignss>/', AssignmentSubmissionListView.as_view(), name='assignment-submission-list'),
