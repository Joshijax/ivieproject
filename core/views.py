...
class AssignmentCreateView(CreateView):
    ...
    def get_success_url(self, *args, **kwargs):
            return reverse_lazy('core:assignment-list', args=[self.kwargs['courz']])
...
class AssignmentView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["course_id"] = self.kwargs['lab']
        return context

    def get_queryset(self):
        print(self.kwargs['lab'])
        return self.model.objects.all().filter(course=self.kwargs['lab'])  # filter(user_id=self.request.user.id).order_by('-id')
...
class AssignmentSubmissionView(CreateView):
    ...
    # def get_context_data(self, **kwargs):
    #     context = super().get_context_data(**kwargs)
    #     assObject = Assignment.objects.get(pk=self.kwargs['assigns'])
    #     return context
    
    def get_context_data(self, **kwargs):
        ctx = super(AssignmentSubmissionView, self).get_context_data(**kwargs)
        ctx['info_sended'] = Assignment.objects.get(pk=self.kwargs['assigns'])
        return ctx
    ...
    def get_queryset(self):
        ...
        return Assignment.objects.get(pk=self.kwargs['assigns'])
...
class AssignmentSubmissionListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["course"] = Assignment.objects.get(pk=self.kwargs['assignss'])
        return context
    ...
    def get_queryset(self):
        print(self.kwargs['assignss'])
        return self.model.objects.all().filter(assignment=self.kwargs['assignss'])  # filter(user_id=self.request.user.id).order_by('-id')
